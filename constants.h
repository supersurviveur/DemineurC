...
extern int const FLAG_CELL;
extern int const PLAYING;
extern int const WON;
extern int const LOST;
extern char const COMMAND_UP;
extern char const COMMAND_DOWN;
extern char const COMMAND_RIGHT;
extern char const COMMAND_LEFT;
extern char const COMMAND_PLACE_FLAG;
extern char const COMMAND_DIG;